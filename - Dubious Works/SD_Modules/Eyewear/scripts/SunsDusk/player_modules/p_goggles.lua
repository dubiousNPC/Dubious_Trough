...
-- table the host owns, on an ordering assumption never checked. If the host
-- ever created it after this module loaded, the handler would be silently
-- discarded. Consumers iterate with pairs(), so both forms are called; only
